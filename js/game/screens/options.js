define('screens/options', ['screens/screen'], function() {
  Game.Screen.Options = Class.create(Game.Screen, {
    counter: 0,
    name: 'Options',
    menu: null,
    rendered: false,
    ...
    init: function() {
      ...
      var options = this.modes.map(function(option) {
        ...
        if (Object.isUndefined(option.value)) {
      ...
      var soundCheckbox = new Element('input', {id: 'options-sounds', type: 'checkbox', checked: Sound.isEnabled()})
        ...
        Sound.setEnabled(e.element().checked)
      });
